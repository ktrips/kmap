...
export const HISTORIC_SITE_CATALOG: HistoricSiteEntry[] = [
  ...
  { id: "meijijingu-gaien-ginkgo", name: "神宮外苑いちょう並木", overlayMapID: "meiji-jingu-omotesando-meiji", coordinate: { lat: 35.6751, lng: 139.7168 } },
  ...
  { id: "kws-shinjuku-station", name: "新宿駅", overlayMapID: "kagurazaka-waseda-shinjuku-meiji", coordinate: { lat: 35.6896, lng: 139.7006 } },

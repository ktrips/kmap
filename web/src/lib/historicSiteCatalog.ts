...
export const HISTORIC_SITE_CATALOG: HistoricSiteEntry[] = [
  ...
  // 元は「神楽坂・早稲田」古地図（廃止）のチェックポイント。古地図の廃止に伴い、君の名は聖地巡礼へ移動した。
  { id: "kws-hanazono-shrine", name: "花園神社", overlayMapID: "kiminona-seichi", coordinate: { lat: 35.6931, lng: 139.7043 } },
  { id: "kws-kagurazaka-zenkokuji", name: "神楽坂・毘沙門天善國寺", overlayMapID: "kiminona-seichi", coordinate: { lat: 35.7017, lng: 139.7397 } },
  { id: "ghibli-museum-mitaka", name: "三鷹の森ジブリ美術館", overlayMapID: "ghibli-seichi", coordinate: { lat: 35.6960, lng: 139.5704 } },
  { id: "ghibli-musashino-park", name: "武蔵野公園（小金井）", overlayMapID: "ghibli-seichi", coordinate: { lat: 35.6998, lng: 139.5210 } },
  { id: "ghibli-shirahige-cream-puff", name: "白髭のシュークリーム（世田谷代田）", overlayMapID: "ghibli-seichi", coordinate: { lat: 35.6636, lng: 139.6634 } },
  { id: "ghibli-shinjuku-gyoen", name: "新宿御苑", overlayMapID: "ghibli-seichi", coordinate: { lat: 35.6852, lng: 139.7100 } },
  ...
  { id: "tokyo-toilet-ebisu-east-park", name: "タコ公園のイカトイレ（恵比寿東公園）", overlayMapID: "tokyo-toilet-perfect-days", coordinate: { lat: 35.6495, lng: 139.7124 } },
  { id: "tokyo-toilet-nabeshima-shoto-park", name: "森のコミチ（鍋島松濤公園）", overlayMapID: "tokyo-toilet-perfect-days", coordinate: { lat: 35.6614, lng: 139.6883 } },
  { id: "tokyo-toilet-yoyogi-fukamachi-mini-park", name: "ザ・トウメイ・トイレット（代々木深町小公園）", overlayMapID: "tokyo-toilet-perfect-days", coordinate: { lat: 35.6697, lng: 139.6825 } },
  { id: "tokyo-toilet-yoyogi-hachiman", name: "スリーマッシュルーム（代々木八幡）", overlayMapID: "tokyo-toilet-perfect-days", coordinate: { lat: 35.6706, lng: 139.6853 } },
  ...
  { id: "tokyo-toilet-jingu-dori-park", name: "あまやどり（神宮通公園）", overlayMapID: "tokyo-toilet-perfect-days", coordinate: { lat: 35.6663, lng: 139.7015 } },
  { id: "tokyo-toilet-ebisu-park", name: "恵比寿公園トイレ", overlayMapID: "tokyo-toilet-perfect-days", coordinate: { lat: 35.6478, lng: 139.7076 } },
  { id: "tokyo-toilet-higashi-sanchome", name: "トライアングル（東三丁目）", overlayMapID: "tokyo-toilet-perfect-days", coordinate: { lat: 35.6524, lng: 139.7089 } },
  ...
  { id: "tokyo-toilet-nishisando", name: "器・泉（西参道）", overlayMapID: "tokyo-toilet-perfect-days", coordinate: { lat: 35.6748, lng: 139.6978 } },

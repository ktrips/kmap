...
- **イラスト画像**（江戸城周辺・浅草周辺・銀座・歌舞伎座）: このサンプルアプリのために生成した
  **古地図"風"のイラスト**で、実際の歴史史料をスキャンしたものではありません。
  ...
  「銀座・歌舞伎座」は、銀座煉瓦街・歌舞伎座・柳並木をモチーフにした自作の汎用デザイン
  （後述のアニメ聖地巡礼向けと同じく、特定の史料・地図データを元にしないオリジナル作画）です。
- **実在の歴史地図**（本郷・谷中・上野／日本橋／芝／神田／東海道／中山道／
  松尾芭蕉ゆかりの地／明治神宮・表参道、および「五色不動めぐり」）:

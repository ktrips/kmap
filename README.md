...
- **現在の地図から加工した「古地図風」画像**（赤坂・紀尾井町／麻布・六本木／
  大山街道〈赤坂〜二子玉川〉／神楽坂・早稲田／「君の名は。」聖地巡礼）:
  ...
  座標から正確に算出しています。「君の名は。聖地巡礼」は須賀神社・四ツ谷駅・ドコモタワー・
  バスタ新宿・カフェ ラ・ボエム（新宿御苑店）・SHIBUYA TSUTAYAをチェックポイントとした、
  映画『君の名は。』の聖地巡礼スポット集です。
